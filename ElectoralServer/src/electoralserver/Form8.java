...
public class Form8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Application for correction to perticulars entered in electoral roll");
        ...
        jLabel5.setText("Pune Assembly / Parliamentary Constituency");

        jLabel6.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel6.setText("Sir,");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel7.setText("I request that entry relating to myself appearing in the electoral roll for the above constituency is not corrected.");

        jLabel8.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel8.setText("Correct particulars in support of my request are given below :");
        ...
        jLabel18.setText("Part Number of Electoral Roll  :");

        jLabel19.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel19.setText("Serial number in that part :");
        ...
        jLabel113.setText("2. Perticular Place of ordinary residance  ( Full Address  )");
        ...
        jLabel115.setText("Stree/Locality/Area/Road :");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Maharashtra", "Punjab", "Tamil nadu", "Andhra Pradesh", "Gujrat", "Karnataka", "Asam" }));
        ...
        jPanel19Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addGroup(jPanel19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel113, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        voterid=Integer.parseInt(jTextField7.getText());
        ...
        try
        {
            ...
            String query="INSERT INTO modification(voterid,firstname,middlename,lastname,sex,dob,age,houseno,streetno,town,state,birthplace,district,pincode,wardno)VALUES('"+voterid+"','"+firstname+"','"+middlename+"','"+surname+"','"+sex+"','"+dob+"','"+age+"','"+houseno+"','"+streetno+"','"+town+"','"+state+"','"+birthplace+"','"+district+"','"+pincode+"','"+wardno+"') ";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Integer wardno,voterid,pincode;     
        voterid=Integer.parseInt(jTextField7.getText());
        pincode=Integer.parseInt(jTextField87.getText());
        
        wardno=pincode%100;
        new Form8_continue(voterid ,wardno).setVisible(true);
        this.dispose();
